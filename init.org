  ...
  (use-package markdown-mode
    ...
    (defun bob/markdown-update-list-bullets (&rest _)
      ...
      (setq markdown-list-item-bullets
            (list
             (propertize "•" 'face 'markdown-list-face)
             (propertize "–" 'face 'markdown-list-face)
             (propertize "◆" 'face 'markdown-list-face)
             (propertize "·" 'face 'markdown-list-face))))
...
#+begin_src elisp
  (use-package flymake
    ...
    (if (fboundp 'member-if)
        (display-warning 'init "member-if is now built-in — remove the compatibility shim from the flymake use-package block in init.org")
      (require 'cl-seq)
