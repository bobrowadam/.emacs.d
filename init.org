...
#+begin_src elisp
  (use-package code-review
    :ensure nil
    :commands (code-review-show-plan
               code-review-open-location
               code-review-open-location-for-kitty
               code-review-load-review
               code-review-load-review-for-kitty
               code-review-send-feedback
               code-review-show-diff
               code-review-commit))
