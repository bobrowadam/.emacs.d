...
#+begin_src elisp
  (use-package markdown-mode
    ...
    (defun bob/markdown-update-list-bullets ()
      "Set markdown list bullets with per-level nerd-icons and theme colors."
      (setq markdown-list-item-bullets
            (list
             (propertize (substring-no-properties (nerd-icons-codicon "nf-cod-circle_filled"))
                         'face `(:family "Symbols Nerd Font Mono" :height 0.45
                                 :foreground ,(or (face-foreground 'font-lock-keyword-face nil t)
                                                  "gold")))
             (propertize (substring-no-properties (nerd-icons-mdicon "nf-md-diamond"))
                         'face `(:family "Symbols Nerd Font Mono" :height 0.40
                                 :foreground ,(or (face-foreground 'font-lock-builtin-face nil t)
                                                  "cyan")))
             (propertize (substring-no-properties (nerd-icons-codicon "nf-cod-triangle_right"))
                         'face `(:family "Symbols Nerd Font Mono" :height 0.45
                                 :foreground ,(or (face-foreground 'font-lock-string-face nil t)
                                                  "green")))
             (propertize (substring-no-properties (nerd-icons-mdicon "nf-md-square"))
                         'face `(:family "Symbols Nerd Font Mono" :height 0.35
                                 :foreground ,(or (face-foreground 'error nil t)
                                                  "red"))))))
