...
#+begin_src elisp
  ...
  (defun bob/kitty-tab-exists-p (tab-id)
    "Return non-nil if Kitty tab with TAB-ID still exists."
    (condition-case nil
        (let ((out (bob/kitten "ls")))
          (and (not (string-empty-p out))
               (string-match-p (regexp-quote (format "\"id\": %s" tab-id)) out)))
      (error nil)))
...
#+begin_src elisp
  (use-package mentat
    ...
    (mentat-use-vui t)
    (mentat-debug t)
    (mentat-rewrite-model "gpt-5.3-codex")
    :config
...
#+begin_src elisp
  (use-package markdown-mode
    ...
    (defun bob/markdown-update-header-faces (&rest _)
      ...
      (set-face-attribute 'markdown-header-face-1 nil :height 1.55 :weight 'bold)
      (set-face-attribute 'markdown-header-face-2 nil :height 1.32 :weight 'bold)
      (set-face-attribute 'markdown-header-face-3 nil :height 1.18 :weight 'semibold)
      (set-face-attribute 'markdown-header-face-4 nil :height 1.08 :weight 'semibold)
      (set-face-attribute 'markdown-header-face-5 nil :height 1.0 :weight 'normal)
      (set-face-attribute 'markdown-header-face-6 nil :height 0.94 :weight 'normal))
