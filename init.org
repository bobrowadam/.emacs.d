...
#+begin_src elisp
  (use-package monet
    ...
    (monet-ediff-cleanup-tool 'monet-ediff-cleanup-tool))
#+end_src
...
** Magit
#+begin_src elisp
  (use-package cond-let :ensure (:repo "tarsius/cond-let" :fetcher github :files ("*.el" "*.texi")))
  (use-package magit
    :custom
...
#+begin_src elisp
  (use-package flymake
    :custom (flymake-show-diagnostics-at-end-of-line 'fancy)
    :config
...
* Grain utils
#+begin_src elisp
  (use-package grain-utils :demand t :ensure nil :after (:any (eglot dired magit)))
#+end_src
* Multiple Cursors
#+begin_src elisp
