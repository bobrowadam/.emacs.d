...
#+begin_src elisp
  (use-package pi-coding-agent
    ...
    :custom
    (pi-coding-agent-input-window-height 0.15)
    (pi-coding-agent-tool-preview-lines 2)
    ...
    (define-key pi-coding-agent-chat-mode-map (kbd "C-c m") #'bob/pi-cycle-solveit-mode)
    (define-key pi-coding-agent-input-mode-map (kbd "C-c m") #'bob/pi-cycle-solveit-mode)
