...
(defun opam-setup-merlin ()
  (print "setupping merlin in opam-user-setup")
  (opam-setup-complete)
  (require 'merlin)
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 61266ea1126031fb495728ebbf127e18 ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (member "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/bob/.opam/default/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/Users/bob/.opam/default/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/Users/bob/.opam/default/bin/ocp-indent"))
