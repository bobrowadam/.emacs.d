...
(defconst modus-nibelung-custom-faces
  '(
    ...
    `(font-lock-builtin-face ((,c :foreground ,modus-nibelung-level-3 :weight normal)))
    `(font-lock-preprocessor-face ((,c :foreground ,modus-nibelung-level-3 :weight normal)))
    `(font-lock-constant-face ((,c :foreground ,modus-nibelung-level-4 :weight normal)))
    `(font-lock-function-call-face ((,c :foreground ,modus-nibelung-accent :weight normal)))
    `(font-lock-function-name-face ((,c :foreground ,modus-nibelung-level-2 :weight normal)))
    `(font-lock-keyword-face ((,c :foreground ,modus-nibelung-level-4 :weight normal)))
    `(font-lock-string-face ((,c :foreground ,modus-nibelung-level-2 :weight normal)))
    `(font-lock-type-face ((,c :foreground ,modus-nibelung-level-3 :weight normal)))
    `(font-lock-variable-name-face ((,c :foreground ,modus-nibelung-level-3 :weight normal)))
    `(font-lock-comment-face
      ((,c :background ,modus-nibelung-level-0 :foreground ,modus-nibelung-level-3 :extend t)))
    `(font-lock-comment-delimiter-face
      ((,c :background ,modus-nibelung-level-0 :foreground ,modus-nibelung-level-3 :extend t)))
    `(font-lock-doc-face ((,c :foreground ,modus-nibelung-level-3)))
