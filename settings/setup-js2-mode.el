...
;; (define-key js2-mode-map (kbd "C-c C-j jt") 'jump-to-test-file)
;; (define-key js2-mode-map (kbd "C-c C-j ot") 'jump-to-test-file-other-window)
;; (define-key js2-mode-map (kbd "C-c C-j js") 'jump-to-source-file)
;; (define-key js2-mode-map (kbd "C-c C-j os") 'jump-to-source-file-other-window)
;; (define-key js2-mode-map (kbd "C-c C-j jo") 'jump-between-source-and-test-files)
;; (define-key js2-mode-map (kbd "C-c C-j oo") 'jump-between-source-and-test-files-other-window)
